...
function buildCommand(args: Args): string[] {
  ...
  if (args.exclude) cmd.push('-g', `!${args.exclude}`);
    ...
    switch (name) {
      case "search":
        result = await executeRipgrep({
          ...
          root: (args as any)?.root,
          path: (args as any)?.path,
          include: (args as any)?.include,
          exclude: (args as any)?.exclude,
          context: (args as any)?.context,
          case_sensitive: (args as any)?.case_sensitive,
          word_boundaries: (args as any)?.word_boundaries,
          file_type: (args as any)?.file_type,
        });
        break;
        
      case "advanced-search":
        result = await executeRipgrep(args as Args);
        break;
